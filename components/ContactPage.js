      ...
      <div className="flex justify-around items-center mx-20 md:flex-row flex-col">
        ...
        <div className="md:w-1/2 w-full md:p-10 my-10 md:my-0  flex-col">
          ...
          <p className="text-gray-300 font-semibold text-sm my-5">
            Fill up the form & we will get back to you within 12 hours.
          </p>
          <div className="flex-col my-20 gap-5 flex  ">
            ...
            <div className="flex gap-5 p-4 border border-gray-500 hover:border-blue-700 md:w-1/2 w-full rounded-lg group cursor-pointer items-center">
              ...
              <p className="text-gray-300 text-base font-semibold group-hover:text-blue-300 group-hover:scale-110">
                molham.sh95@gmail.com
              </p>
            </div>
            <div className="flex gap-5 p-4 border border-gray-500 hover:border-blue-700 md:w-1/2 w-full rounded-lg group cursor-pointer items-center">
              <GrMail className="text-xl text-gray-500  group-hover:text-white" />
              <p className="text-gray-300 text-base font-semibold group-hover:text-blue-300 group-hover:scale-110">
                molham.shaker@pandiv.com
              </p>
            </div>
            <div className="flex gap-5 p-4 border border-gray-500 hover:border-blue-700 md:w-1/2 w-full rounded-lg group cursor-pointer items-center">
        ...
        <div className="bg-gradient-to-r from-pink-900 to-purple-500 p-12 rounded-3xl shadow-md">
          <form>
            ...
            <button
              type="submit"
              className="text-white bg-blue-700 hover:bg-blue-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Send Message
            </button>
          </form>
